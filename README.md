...
Since the end of November 2020, the Linux drivers included in this book have been adapted to run on the Raspberry Pi 4 Model B board using the Linux kernel version 5.4 LTS. The kernel 5.4 modules developed for the Raspberry Pi 4 Model B board are included in the linux_5.4_rpi4_drivers.zip file and can be downloaded from this GitHub repository. The Raspberry Pi 4 Practical Labs Setup is described in the Linux_5.4_rpi4_practical_labs document included in this repository. The new MAX11300 driver, CY8C9520A driver and CY8C9520A_pwm_pinctrl driver have been ported to the Raspberry Pi 4 Model B board using kernel 5.4 and are included in the linux_5.4_rpi4_drivers.zip file.
